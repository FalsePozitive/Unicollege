				...
				<main id="main" class="site-main">
					<article id="<?php echo $post_id;?>" class="post-<?php echo $post_id;?> page type-page status-publish hentry">
						...
						?>
							<div class="entry-content">
								<div class="col-12">
									<button class="accordion">Course Fees</button>
									<div class="panel" style="padding: 10px 0px;">
										<p><?php echo $pricing_indicater;?></p>
										<?php
										if(count($learning_method) == '0')
										{
											echo "No Data Found";
										}
										elseif(count($learning_method) == '1')
										{
											$column_class = 'col-lg-12';
										}
										elseif(count($learning_method) == '2')
										{
											$column_class = 'col-lg-6';
										}
										elseif(count($learning_method) == '3')
										{
											$column_class = 'col-lg-4';
										}
										elseif(count($learning_method) == '4')
										{
										...
										{
										?>
											<div class="<?php echo $column_class;?> custom_class fess_custom_class">
												<?php
												if($learning_methods['value'] == "full_time")
								         		{
								         			echo '<div class="fees_button" style = "background-color:#B50E20; color:#fff;">FULL TIME</div>';
								         			echo '<p class="fess_p_class">Registration Fee: '.$currency."".$full_time_registration_fee.'</p>';
								         			echo '<p class="cash_p_class">Full Cash Fee: '.$currency."".$full_time_cash_fee.'</p>';
								         			echo '<p class="terms_p_class">Terms Fee: '.$currency."".$full_time_total_terms_fee.'</p>';
								         			echo '<p class="deposit_p_class">Deposit: '.$currency."".$full_time_deposit.'</p>';
								         			echo '<p class="month_p_class">Monthly Instalment: '.$currency."".$full_time_monthly_instalment.' x '.$full_time_no_of_months.'</p>';
								         		}
								         		elseif($learning_methods['value'] == "part_time")
								         		{
								         			echo '<div class="fees_button" style = "background-color:#322668; color:#fff;">PART TIME</div>';
								         			echo '<p class="fess_p_class">Registration Fee: '.$currency."".$part_time_registration_fee.'</p>';
								         			echo '<p class="cash_p_class">Full Cash Fee: '.$currency."".$part_time_cash_fee.'</p>';
								         			echo '<p class="terms_p_class">Terms Fee: '.$currency."".$part_time_total_terms_fee.'</p>';
								         			echo '<p class="deposit_p_class">Deposit: '.$currency."".$part_time_deposit.'</p>';
								         			echo '<p class="month_p_class">Monthly Instalment: '.$currency."".$part_time_monthly_instalment.' x '.$part_time_no_of_months.'</p>';
								         		}
								         		elseif($learning_methods['value'] == "online")
								         		{
								         			echo '<div class="fees_button" style = "background-color:#F35E02; color:#fff;">ONLINE</div>';
								         			echo '<p class="fess_p_class">Registration Fee: '.$currency."".$online_registration_fee.'</p>';
								         			echo '<p class="cash_p_class">Full Cash Fee: '.$currency."".$online_cash_fee.'</p>';
								         			/*echo '<p class="terms_p_class">Terms Fee: '.$currency."".$online_total_terms_fee.'</p>';
								         			echo '<p class="deposit_p_class">Deposit: '.$currency."".$online_deposit.'</p>';
								         			echo '<p class="month_p_class">Monthly Instalment: '.$currency."".$online_monthly_instalment.' x '.$online_no_of_months.'</p>';*/
								         		}
								         		elseif($learning_methods['value'] == "workshops")
								         		{
								         			echo '<div class="fees_button1" style = "background-color:#767676; color:#fff;">WORKSHOPS</div>';
								         			echo '<p class="fess_p_class">Registration Fee: '.$currency."".$workshop_registration_fee.'</p>';
								         			echo '<p class="cash_p_class">Full Cash Fee: '.$currency."".$workshop_cash_fee.'</p>';
								         		} 
												?>
											</div>
										<?php	
